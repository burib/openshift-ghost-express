...
if (process.env.OPENSHIFT_MYSQL_DB_HOST != undefined) {
  config = {
    ...
    production: {
      ...
      paths: {
        contentPath: path.join(__dirname, '/../ghost_content/')
      }
    }
  }
  ...
  config = {
    ...
    development: {
      ...
      database: {
        client: 'sqlite3',
        connection: {
          filename: path.join(__dirname, '/../ghost_content/data/ghost-dev.db')
        },
        debug: false
      },
      server: {
    ...
    production: {
      ...
      database: {
        client: 'sqlite3',
        connection: {
          filename: path.join(__dirname, '/../ghost_content/data/ghost.db')
        },
        debug: false
      },
      server: {
    ...
    testing: {
      ...
      database: {
        client: 'sqlite3',
        connection: {
          filename: path.join(__dirname, '/../ghost_content/data/ghost-test.db')
        }
      },
      server: {
        host: '127.0.0.1',
